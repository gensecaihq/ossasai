...
<Note>
General controls are the foundation upon which all other controls are built. Failure to implement these controls undermines the entire security architecture.
</Note>
...
<Steps>
  <Step title="Audit Default Configuration">
  ...
  <Step title="Remove Opt-in Requirements">
...
<Tabs>
  <Tab title="Fail-Closed Configuration">
  ...
  <Tab title="Error Response Security">
...
<Tabs>
  <Tab title="Minimal Default Permissions">
  ...
  <Tab title="Privilege Escalation Controls">
  ...
  <Tab title="Runtime Privilege Audit">
...
<Tabs>
  <Tab title="Layered Architecture">
  ...
  <Tab title="Failure Mode Analysis">
