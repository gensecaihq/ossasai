...
> **Note:** **Design Philosophy:** "Access control before intelligence." Most AI agent security failures are not sophisticated exploits—they're cases where "someone messaged the bot and the bot did what they asked." OSSASAI's stance: Identity first, scope next, model last.
...
Core requirements using RFC 2119 normative language (MUST/SHOULD/MAY)
  ...
  ### [Threat Model](/threat-model/overview)
...
30 security controls across 8 domains
  ...
  ### [Implementation](/implementation/quickstart)
...
Official implementation profile for OpenClaw AI agent runtime. Complete control mapping with CLI-based verification.
  ...
  ### [Create a Profile](/profiles/overview)
