...
**OSSASAI Top 10**
: Primary failure modes prioritized by OSSASAI: (1) Prompt injection → tool misuse, (2) Over-privileged tools, (3) Exposed control plane, (4) Session boundary collapse, (5) Secrets leakage, (6) Unsafe browsing/connectors, (7) Extension supply chain, (8) Memory poisoning, (9) Missing auditability, (10) Unsafe defaults + drift.
