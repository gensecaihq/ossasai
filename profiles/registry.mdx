...
<Note>
Profile maintainers should register their profiles here to receive notifications about framework changes that may affect their implementations.
</Note>
...
<CardGroup cols={2}>
  <Card title="OCSAS" icon="terminal" href="/profiles/openclaw">
...
<Steps>
  ...
  <Step title="Submit Registration">
    ...
    - Update `registry.mdx` with your profile
    - Submit pull request
  </Step>
