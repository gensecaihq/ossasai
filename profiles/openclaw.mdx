...
<Note>
OCSAS is maintained by the OSSASAI project team and serves as the reference implementation for other profiles.
</Note>
...
<Accordion title="GEN Control Configuration Details">
...
<Accordion title="CP Control Configuration Details">
...
<Accordion title="ID Control Configuration Details">
...
<Accordion title="TB Control Configuration Details">
...
<Accordion title="LS Control Configuration Details">
...
<Accordion title="SC Control Configuration Details">
...
<Accordion title="FV Control Configuration Details">
...
<Accordion title="NS Control Configuration Details">
...
<Steps>
  ...
  <Step title="Initialize with Security Baseline">
    ```bash
...
<Steps>
  ...
  <Step title="Configure Network Monitoring">
    ```bash
    openclaw monitor enable --anomaly-detection
    ```
  </Step>
  <Step title="Enable Formal Verification (Optional)">
    ```bash
    openclaw verification enable --invariants
    ```
  </Step>
  <Step title="Verify L3 Compliance">
    ```bash
