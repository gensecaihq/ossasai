    ...
    steps:
      ...
      - name: OSSASAI Audit
        run: |
          ...
          curl -sSL https://ossasai.dev/tools/ossasai-audit.sh -o ossasai-audit.sh
          curl -sSL https://ossasai.dev/tools/ossasai-audit.sh.sha256 -o ossasai-audit.sh.sha256
